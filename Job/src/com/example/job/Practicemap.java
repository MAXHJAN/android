...
public class Practicemap extends Activity{
	//地理编码变量
	...
	public void onCreate(Bundle  savedInstanceState)
    {
	 ...
	 city=b.getString("city");
	  ...
	  mapView = (MapView) findViewById(R.id.mapView);
	  	...
	  	initLocation(); 
	  	/****************************************************************************************************/
		  SharedPreferences preferences = getSharedPreferences("city2", Activity.MODE_PRIVATE);
		...
		baiduMap.setOnMarkerClickListener(new OnMarkerClickListener() {
			...
			public boolean onMarkerClick(Marker marker) {
				...
				intent.setClass(Practicemap.this,JobinfoActivity.class);
	...
	{
		 String[] a={"湖南省育坤教育科技有限公司 ","湖南卓睿科技有限公司 ","湘潭市贝一科技有限公司 ","湘潭县微众信息科技有限公司 ","湘潭市岳塘区天利网络服务部 ",  		    		
				 "湘乡市广厦信息服务有限公司 ","湘潭市神钜机电科技有限公司 "};
		String[] b={"web前端开发工程师","前端开发软件工程师","程序员","网页设计/制作","移动应用开发工程师","软件工程师#程序员","软件工程师"};
		listview=(ListView) findViewById(R.id.map_listView1);
		 ...
		 SimpleAdapter adapter=new SimpleAdapter(Practicemap.this, mData,R.layout.jobmap,new String[]{"comp","job","address","city"},new int[]{R.id.j_t1,R.id.j_t2,R.id.j_t3,R.id.j_t4});
